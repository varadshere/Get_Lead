$( document ).ready( function () {
    $.getScript('../config/config.js', function() {
        ...
        // config.serverURL = 'http://18.188.167.167:5000/api/';
        ...
        $( "#signupForm1" ).validate( {
            rules: {
                ...
                email: {
                    ...
                    email: true,
                    remote: {
                        url: config.serverURL + "checkUser",
                        type: "post",
        ...
        $('#finish').click(function(e) {
            ...
            console.log($('#cname').val());
                ...
                $.post(config.serverURL + "insert", JSON.stringify(dataToSend), function(data, status){
                    if(data.result){
                        $loading.hide();
